...
from AuxUtils import split, string_to_bit_conv, bits_to_string_conv, permute, xor, expand, substitute, shift, padd, depadd
...
class DES:
    ...
    def run(self, key, text, encrypt=True):
        self.key = key
        self.text = text
        ...
        return depadd(final_res) if not encrypt else final_res
